        ...
        <div class="row bg-secondary py-1 px-xl-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-light" onclick="window.location.href='Login.html'">Login</button>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    ...
                    <div class="text-center py-4">
                        ...
                        <a class="h6 text-decoration-none text-truncate" style="font-size: 15px;" href="">Lorem ipsum dolor sit amet, <br>consectetur adipiscing elit.</a>
