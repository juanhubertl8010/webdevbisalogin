...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <style>
    .form-label {
      padding-top: 1000px; /* Sesuaikan dengan nilai padding yang diinginkan */
    }
    ...
    <section class="breadcrumbs">
        <div class="container">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <h2 style="font-weight: bold; color:#173c7c">Add Games</h2>
          </div>
        </div>
        <br>
        <br>
                ...
                <div class="card-body">
                  <form action="#" method="post" role="form" class="php-email-form">
                    <div class="mb-3">
                      ...
                      <input type="text" name="gameName" class="form-control" id="gameName" placeholder="Enter game name" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="Genre" class="form-control" id="Genre" placeholder="Enter Genre" required>
                    </div>
                    <div class="text-center"><button type="submit" class="submit-btn">Submit</button></div>
                  </form>
                </div>
              </div>
            </div>
