...
<head>
    ...
    top: 0;
    right: 0;
    opacity: 0; /* Mengatur opacity awal menjadi 0 sehingga ikon tidak terlihat */
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{ route('adminhome') }}" class="nav-item nav-link active">Home</a>
                            <a href="{{route('shopadmin')}}" class="nav-item nav-link">Product</a>
                            <a href="{{route('users.index')}}" class="nav-item nav-link">All User</a>
                            <a href="{{route('allwishlist.show')}}" class="nav-item nav-link">All Wishlist</a>
                            <a href="{{route('allcart.show')}}" class="nav-item nav-link">All Cart</a>
                            <a href="{{route('alltrans.show')}}" class="nav-item nav-link">All Transaction</a>
                        </div>
                    </div>
                </nav>
            </div>
                        ...
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="{{ url('shop/G0001') }}">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Lorem rebum magna amet lorem magna erat diam stet. Sadips duo stet amet amet ndiam elitr ipsum diam</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="{{ url('shop/G0002') }}">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Lorem rebum magna amet lorem magna erat diam stet. Sadips duo stet amet amet ndiam elitr ipsum diam</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="{{ url('shop/G0006') }}">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
