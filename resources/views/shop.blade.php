                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <a class="h6 text-decoration-none text-truncate" style="font-size: 12px;" href="">luna</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <a class="h6 text-decoration-none text-truncate" style="font-size: 15px;" href="">Bawa timmu ke kemenangan</a>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-primary mr-1"></small>
                                    <small class="fa fa-star text-primary mr-1"></small>
                                    <small class="fa fa-star text-primary mr-1"></small>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <a class="h6 text-decoration-none text-truncate" style="font-size: 15px;" href="">Reach Challenger rank quickly <br>consectetur adipiscing elit.</a>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-primary mr-1"></small>
                                    <small class="fa fa-star text-primary mr-1"></small>
                                    <small class="fa fa-star text-primary mr-1"></small>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <a class="h6 text-decoration-none " style="font-size: 12px;" href="">Seller Name</a>
                            </div>
                        </div>
                    </div> -->
                    <div class="container">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    &copy; <a class="text-primary" href="#">JokiGaming</a>. All Rights Reserved. Designed by
