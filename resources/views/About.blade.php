...
<body>
  ...
  <!-- About Paragraph -->
  <div class="container">
    <p class="about-paragraph">We are a team of passionate individuals dedicated to excellence.</p>
  </div>
  ...
  <div class="container team-cards">
    <!-- Team Member 1 -->
    <div class="card">
      <img src="img/Fotoku.jpeg" width="300" height="300" class="card-img-top" alt="Team Member 1">
      <div class="card-body">
        <h5 class="card-title">Juan Hubert Liem</h5>
        <p class="card-text">Leader</p>
      </div>
    </div>
    <!-- Team Member 2 -->
    <div class="card">
      <img src="img/Rangga.png" width="300" height="300" class="card-img-top" alt="Team Member 2">
      <div class="card-body">
        <h5 class="card-title">Rangga Rijasa</h5>
        <p class="card-text">Member</p>
      </div>
    </div>
    <!-- Team Member 3 -->
    <div class="card">
      <img src="img/Ken.png"width="300" height="300" class="card-img-top" alt="Team Member 3">
      <div class="card-body">
        <h5 class="card-title">Kenneith Wijaya</h5>
        <p class="card-text">Member</p>
      </div>
    </div>
    <!-- Team Member 4 -->
    <div class="card">
      <img src="img/Valen.png" class="card-img-top" alt="Team Member 4">
      <div class="card-body">
        <h5 class="card-title">Valent Rafael</h5>
        <p class="card-text">Member</p>
      </div>
    </div>
  </div>
