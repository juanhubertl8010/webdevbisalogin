...
<body>
            ...
            <div class="col-lg-9 d-flex justify-content-center">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a href="{{ route('adminhome') }}" class="nav-item nav-link ">Home</a>
                            ...
                            <a href="{{route('alltrans.show')}}" class="nav-item nav-link active">All Transaction</a>
                        </div>
                    </div>
                </nav>
            </div>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5 justify-content-center mb-3">
            <div class="col-lg-8">
                <form action="{{ url('alltrans') }}" method="GET">
            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        @empty
                            <tr>
                                <td colspan="4">No items in Transaksi</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
